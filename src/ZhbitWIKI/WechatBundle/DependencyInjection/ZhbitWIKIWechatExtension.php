 ...
 */
class ZhbitWIKIWechatExtension extends Extension
{
    /**
     * @param array $configs
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $definition = $container->getDefinition('zhbitwiki_wechat.extension.wechat.sdk');
        $argument = array(
            'debug' => false,
        ...
        if (array_key_exists('alias', $config)) {
            $container->setAlias($config['alias'], 'zhbitwiki_wechat.extension.wechat.sdk');
        }
    }
